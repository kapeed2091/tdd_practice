...
class TestCreateAccount(TestCase):
    ...
    def testcase_create_multiple_accounts_for_different_users(self):
        ...
        self.assertEquals(account_details_2['customer_id'],
                          customer_id_2, 'Issue with customer_id')
        self.assertNotEqual(account_details_1['account_id'],
                            account_details_2['account_id'])
    ...
    def testcase_joint_account_holder(self):
        ...
        Account.assign_account_id_to_customer(account_id=account_id,
                                              customer_id=customer_id_1)
        self.assertRaises(Exception,
                          lambda: Account.assign_account_id_to_customer(
                              account_id=account_id, customer_id=customer_id_2))
