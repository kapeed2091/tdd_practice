...
class TestCreateAccount(TestCase):
    ...
    def testcase_create_account(self):
        ...
        self.assertNotEqual(account_details['account_id'], None,
                            'Issue with account_id')
    ...
    def testcase_create_multiple_accounts_for_different_users(self):
        ...
        self.assertEquals(account_details_1['customer_id'], customer_id_1,
                          'Issue with customer_id')
        self.assertEquals(account_details_2['customer_id'], customer_id_2,
                          'Issue with customer_id')
